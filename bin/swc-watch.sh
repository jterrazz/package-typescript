...
nodemon --quiet --watch src/* --exec "swc $IN_PATH --source-maps --quiet --copy-files --config-file $TMP_SWCRC --out-dir $OUT_PATH --strip-leading-paths && node $OUT_PATH/index.js"
