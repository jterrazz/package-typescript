...
The exceptions the gate never touches — a closed list, plus `.next` under one condition — are [the pass's own chapter](06-quality-checks.md#the-closed-exception-list)'s.
