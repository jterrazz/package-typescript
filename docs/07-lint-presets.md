...
The `@jterrazz/typescript/oxlint` entry ships named presets, a `compose(...)` merger, and oxlint's own `defineConfig` — projects wire the fragments they want, explicitly, importing this package alone ([Developing](02-developing.md)).
